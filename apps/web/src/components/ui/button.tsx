...
const variants = cva("ui-button", { variants: { variant: { default: "ui-button-primary", secondary: "ui-button-secondary", ghost: "ui-button-ghost" } }, defaultVariants: { variant: "default" } });
